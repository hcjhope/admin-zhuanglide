...
<%@ include file="/jsp/include/base.jsp"%>
<title>登陆</title>
...
<body>
	<div id="login">
		<div id="login_header">
			<h1 class="login_logo">
				<a href="javascript:;"><img src="<%=contextPath %>/images/login_logo.gif" /></a>
			</h1>
			<div class="login_headerContent">
				...
				<h2 class="login_title"><img src="<%=contextPath %>/images/login_title.png" /></h2>
			</div>
		</div>
		<div id="login_content">
			...
			<div class="login_banner"><img src="<%=contextPath %>/images/login_banner.jpg" /></div>
